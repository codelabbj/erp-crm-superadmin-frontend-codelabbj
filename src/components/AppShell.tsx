  ...
  return (
    <div className="min-h-screen">
      <aside className="fixed top-0 left-0 bottom-0 w-72 overflow-y-auto border-r border-slate-200 bg-slate-100 p-4 dark:border-slate-800 dark:bg-slate-950">
        ...
        <div className="mb-1 px-2 text-[11px] font-semibold uppercase tracking-wide text-slate-400 dark:text-slate-500">Vue d&apos;ensemble</div>
        ...
        <div className="mt-3 mb-1 px-2 text-[11px] font-semibold uppercase tracking-wide text-slate-400 dark:text-slate-500">Gestion des tenants</div>
        ...
        <div className="mt-3 mb-1 px-2 text-[11px] font-semibold uppercase tracking-wide text-slate-400 dark:text-slate-500">Revenus & plans</div>
        ...
        <div className="mt-3 mb-1 px-2 text-[11px] font-semibold uppercase tracking-wide text-slate-400 dark:text-slate-500">Operations plateforme</div>
        ...
        <button
          className={navBtn(tab === "staffUsers")}
          onClick={() => setTab("staffUsers")}
        >
          <Users2 size={16} />
          Utilisateurs staff
        </button>
        <div className="mt-3 mb-1 px-2 text-[11px] font-semibold uppercase tracking-wide text-slate-400 dark:text-slate-500">Securite & conformite</div>
