        ...
        <table className="min-w-full text-sm">
          <thead>
            <tr>
              ...
              <th className="px-2 py-2 text-left font-semibold text-slate-700 dark:text-slate-300">Expiration</th>
            ...
            {(data?.results ?? []).map((org) => (
              ...
              >
                ...
                <td className="px-2 py-2 text-slate-700 dark:text-slate-300">
                  {formatIsoDate(org.plan_expires_at ?? undefined)}
                </td>
                <td className="px-2 py-2">
                  <span
          ...
          <div className="grid gap-3 md:grid-cols-2">
            <div ref={assignPlanRef} className="rounded-lg border border-slate-200 p-3 dark:border-slate-700">
              <p className="m-0 mb-2 text-sm text-slate-700 dark:text-slate-300">
                ...
                <strong>
                  {formatIsoDate(
                    orgDetailQuery.data?.plan_expires_at ?? selectedOrg?.plan_expires_at ?? undefined,
                  )}
                </strong>
              </p>
