  ...
  return (
    <div className="grid min-h-screen place-items-center bg-surface-bg p-4 dark:bg-slate-950">
      <div className="w-[min(96vw,440px)] rounded-2xl border border-border-soft bg-white p-6 shadow-xl dark:border-slate-800 dark:bg-slate-900">
        <h1 className="m-0 text-xl font-semibold text-slate-900 dark:text-slate-100">Mot de passe oublié</h1>
        <p className="mt-1 text-sm text-slate-500">Console Super Admin — lien valide 24 h</p>

        {sent ? (
          <div className="mt-4 grid gap-3">
            <p className="m-0 text-sm text-slate-600 dark:text-slate-300">
              Si un compte console actif correspond à <strong>{email}</strong>, un e-mail de réinitialisation vient
              d&apos;être envoyé. Vérifiez aussi les spams.
            </p>
